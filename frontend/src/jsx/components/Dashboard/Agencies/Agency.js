					...
					<Tab.Container defaultActiveKey='Setting'>					
						<Nav as='ul' className="nav nav-tabs">
							<Nav.Item as='li' className="nav-item">
								<Nav.Link to="#profile-settings" eventKey='Setting'>Détails de l'agence</Nav.Link>
							</Nav.Item>
						</Nav>
						<Tab.Content>
												...
												<div className="">
													<div className="">
														<div className="me-3 mb-3">
															<h4 className="card-title mb-2">Agents</h4>
														</div>
													</div>
													<Tab.Content className="card-body p-0" key={"prevv-tabus"}>
														<Tab.Pane className="tab-pane" eventKey="Today">
															<div className="table-responsive">
															  {country.agents.length === 0 ? (
																<div className="">
																<p className="btn btn-outline-primary mb-3">Aucun agent disponible pour cette agence.</p>
																</div>
																) : (
